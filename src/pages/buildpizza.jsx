...
const BuildPizza=()=>{
  ...
  if (!data) {
    ...
    <div class="panel controls">
      <ul>
        <li>
          <button class="btn btn-pepperonni active" onClick={()=>setPepp(!pepp)}>Pepperonni</button>
        </li>
        <li>
          <button class="btn btn-mushrooms active" onClick={()=>setMush(!mush)}>Mushrooms</button>
        </li>
        <li>
          <button class="btn btn-green-peppers active" onClick={()=>setGreenPepp(!greenpepp)}>Green peppers</button>
        </li>
        <li>
          <button class="btn btn-sauceyy active" onClick={()=>setWhitesauce(!whitsauce)}>White sauce</button>
        </li>
        <li>
          <button class="btn btn-crust active" onClick={()=>setCrust(!crustt)}>Gluten-free crust</button>
        </li>
      </ul>
    </div>
    <aside class="panel price">
      ...
      <strong>Rs.<span id="totalPrice">{200+pepp*10+mush*10+greenpepp*10+whitsauce*30+crustt*50}</span></strong>
