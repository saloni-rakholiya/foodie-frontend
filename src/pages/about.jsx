...
const About =()=>{
    ...
    <h1>ABOUT</h1>
	<p style={{color:"white"}}>Foodie is a world class restaurant, famous for its pizzas and known highly for its great and fast online service. Started by a group of friends, they ensure both offline and online service is equally incredible. At Foodie, customers come first!</p>
     </>
    );
}
